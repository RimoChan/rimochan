...
+ 传统算法:
    ...
    [![]()]()
    - [【RCM】色色匹配算法](https://github.com/RimoChan/rimo_color_match)
    <a href='https://github.com/RimoChan/rimo_color_match'><img align='middle' src='https://unv-shield.librian.net/api/unv_shield?repo=RimoChan/rimo_color_match'></img></a>
    [![]()]()
...
如果你是莉沫酱的粉丝，也可以来 Librian幼酒ciallo_ssh喵喵喵喵贴贴再教育探险环合唱可爱SSL晚安爱爱中💕幼翼学校<sub>(<https://t.me/+b2LkdtsyistjMDk1>)</sub> 一起睡觉。